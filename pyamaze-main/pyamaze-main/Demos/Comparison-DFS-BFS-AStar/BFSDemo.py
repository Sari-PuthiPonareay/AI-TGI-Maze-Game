...
if __name__=='__main__':
    ...
    m.CreateMaze(loadMaze = 'maze--2022-07-09--14-48-16.csv',theme='light')
    bSearch,bfsPath,fwdPath=BFS(m)
    ...
    l = textLabel(m,'bfsPath',len(bfsPath)+1)
    f = textLabel(m,'bSearch',len(bSearch)+1)
    g = textLabel(m,'fwdPath',len(fwdPath)+1)
    m.run()